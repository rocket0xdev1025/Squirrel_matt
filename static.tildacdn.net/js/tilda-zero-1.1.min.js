...
function t396__initOnlyScalable() {
  ...
  void 0 === window.isOnlyScalable &&
    ...
    (window.shouldUseScaleFactor = !window.isOnlyScalable && !t && i <= 127));
}
function t396__setGlobalScaleVariables(t, e, i) {
  window.tn_window_width = document.documentElement.clientWidth;
  t = "ab" + t;
  i
    ? ((window.tn[t].scaleFactor = parseFloat(
        (window.tn_window_width / e).toFixed(3)
      )),
      (window.tn_scale_factor = parseFloat(
        (window.tn_window_width / e).toFixed(3)
      )))
    : ((window.tn[t].scaleFactor = 1), (window.tn_scale_factor = 1));
}
function t396__processTopShift(t, e, i) {
  "function" != typeof window.t396__updateTopShift ||
    ("y" !== t396_ab__getFieldValue(t, "shift-processed") &&
      "y" !== t396_ab__getFieldValue(t, "fixed-shift")) ||
    t396__updateTopShift(e, i);
}
function t396_doResize(t) {
  var e = t396_isOnlyScalableBrowser(),
    ...
    r = i ? i.querySelector(".t396__scale-style") : null,
    a =
      (t396__setScaleFactorForElements(t),
      t396_removeElementFromDOM(r),
      e
        ? ((r = i ? i.querySelectorAll(".tn-molecule, .tn-atom") : []),
          Array.prototype.forEach.call(r, function (t) {
            var e, i;
            (t.classList.contains("tn-atom") && t.closest(".tn-molecule")) ||
              ((i = (e = t.closest(".tn-atom__scale-wrapper"))
                ? e.parentNode
                : null) && i.removeChild(e),
              i && i.appendChild(t));
          }))
        : ((e = i ? i.querySelectorAll(".t396__elem") : []),
          Array.prototype.forEach.call(e, function (t) {
            ...
            t &&
              ...
              (t.style.fontSize = ""),
              (t.style.webkitTextSizeAdjust = ""));
          })),
      t396_switchResolution(t, o),
      i ? i.querySelector(".t396__artboard") : null),
    r = "window" === t396_ab__getFieldValue(a, "upscale"),
    e =
      (t396__setGlobalScaleVariables(t, o, r),
      t396_updateTNobj(t),
  ...
  r &&
    ...
    t396__processTopShift(a, t, !0),
    t396_allelems__renderView(a),
    t396_allgroups__renderView(a),
    a &&
      [
        a,
        a.querySelector(".t396__carrier"),
        a.querySelector(".t396__filter"),
      ].forEach(function (t) {
        t && (t.style.height = "");
      });
}
    ...
    ("fixed" !== (n = t396_ab__getFieldValue(t, "pos")) &&
      ...
      "absolute" !== n
        ...
        : ((n = getComputedStyle(t)),
          (i =
            !(i = t.querySelector(".t396__filter")) ||
            "none" === getComputedStyle(i).backgroundImage),
          (n =
            "rgba(0, 0, 0, 0)" === n.backgroundColor &&
            "none" === n.backgroundImage),
...
function t396_setScreensTNobj(t, e) {
  var i = "ab" + t,
    t =
      ((window.tn[i] = {}),
      (window.tn[i].screens = []),
      e.getAttribute("data-artboard-screens"));
  t
    ...
    (t &&
      ...
      [document.body, t].reduce(function (t, e) {
        var i = window.getComputedStyle(e).paddingLeft,
          e = window.getComputedStyle(e).paddingRight;
...
function t396_updateTNobj(t) {
  for (
    var e = t396__getAxisXPadding(),
      i =
        ((window.tn.window_width = document.documentElement.clientWidth),
        e && (window.tn.window_width -= e),
        (window.tn.window_height = window.t396__isMobile
          ? document.documentElement.clientHeight
          : window.innerHeight),
        "ab" + t),
      n = window.tn[i].screens.slice().reverse(),
      o = 0;
    o < n.length;
    o++
  )
    window.tn[i].curResolution === n[o] &&
      ((window.tn[i].canvas_min_width = n[o]),
      (window.tn[i].canvas_max_width =
        0 === o ? window.tn.window_width : n[o - 1]));
  (window.tn[i].grid_width = window.tn[i].canvas_min_width),
    (window.tn[i].grid_offset_left =
      (window.tn.window_width - window.tn[i].grid_width) / 2);
}
...
var t396_waitForFinalEvent = (function () {
  ...
  return function (t, e, i) {
    n[(i = i || "Don't call this twice without a uniqueId")] &&
      clearTimeout(n[i]),
      (n[i] = setTimeout(t, e));
  };
})();
function t396_switchResolution(t, e) {
  ...
  (window.tn[t].curResolution = e),
    (window.tn[t].curResolution_max = i),
    (window.tn.curResolution = e),
    (window.tn.curResolution_max = i);
}
function t396_artboard_build(t, e) {
  ...
  t396_ab__renderView(o),
    t396_allgroups__renderView(o),
    t396__setScaleFactorForElements(e);
  var r = document.createEvent("Event"),
    a =
      (r.initEvent("artBoardRendered", !0, !0), o.querySelectorAll(".tn-elem")),
    a =
  ...
  ("visible" !== a && "visibleX" !== a) ||
    !n ||
    ((n.style.overflow = "hidden"),
    document.querySelector(
      ".t951__sidebar_sticky,.t-store__prod-popup__col_fixed"
    ) && (n.style.cssText += "overflow:clip;")),
    "auto" === a &&
      0 !== (r = Math.abs(o.offsetHeight - o.clientHeight)) &&
      (o.style.paddingBottom = r + "px"),
    (window.t396__isMobile || window.t396__isIPad) &&
...
function t396_ab__renderView(t) {
  if (!t) return !1;
  for (
    var e = window.tn.ab_fields,
      i = document.getElementById("allrecords"),
      n = 0;
    n < e.length;
    n++
  )
    t396_ab__renderViewOneField(t, e[n]);
  var o,
    r,
    a = t396_ab__getFieldValue(t, "height"),
    l = t396_ab__getHeight(t),
  ...
  if ((_ && !i && s && (o = parseInt(a, 10) * d), a === l || (o && l <= o)))
    r = 0;
  else
    switch (t396_ab__getFieldValue(t, "valign")) {
      ...
      case "center":
        r = o
          ? parseFloat(((l - o) / 2).toFixed(1))
          : parseFloat(((l - a) / 2).toFixed(1));
        break;
      case "bottom":
  ...
  t.setAttribute("data-artboard-proxy-min-offset-top", r),
    t.setAttribute("data-artboard-proxy-min-height", a),
    t.setAttribute("data-artboard-proxy-max-height", l);
  (_ = t.querySelector(".t396__filter")),
    (i = t.querySelector(".t396__carrier"));
  (s = t396_ab__getFieldValue(t, "height_vh")),
    (s = parseFloat(s)),
    (window.t396__isMobile || window.t396__isIPad) &&
      s &&
      ((d = (document.documentElement.clientHeight * s) / 100),
      (t.style.height = d + "px"),
      _ && (_.style.height = d + "px"),
      i && (i.style.height = d + "px"));
}
function t396__getCurrentScaleFactor(t) {
  t = "ab" + t;
  return (
    (window.tn && window.tn[t] && window.tn[t].scaleFactor) ||
...
function t396__setScaleFactorForElements(t) {
  var e,
    i = document.getElementById("rec" + t),
    i = i ? i.querySelector(".t396__artboard") : null;
  i &&
    ((e = t396__getCurrentScaleFactor(t)),
    (t = i.querySelectorAll(".t396__elem, .tn-group")),
...
function t396_addImage(t, e) {
  ...
  (e = t396_getEl(e)) &&
    ...
    (i = e.querySelector("img")) &&
      ...
      i.addEventListener("tuwidget_done", function () {
        t396_elem__renderViewOneField(e, "top");
      }),
...
function t396_addShape(t, e) {
  (e = t396_getEl(e)) &&
    (e.setAttribute(
      "data-fields",
      "width,height,top,left,container,axisx,axisy,widthunits,heightunits,leftunits,topunits"
    ),
    t396_elem__renderView(e),
    t396_processElemTransform(e));
}
function t396_processElemTransform(t) {
  ...
  !(
    (i.backdropFilter && "none" !== i.backdropFilter) ||
    (i.webkitBackdropFilter && "none" !== i.webkitBackdropFilter)
  ) ||
    ("none" !==
      (e =
        "matrix(1, 0, 0, 1, 0, 0)" ===
        (e = (i = t.querySelector(".tn-atom"))
          ? window.getComputedStyle(i).transform
          : "none")
          ? "none"
          : e) &&
      ((i.style.transform = "none"), (t.style.transform = e)));
}
function t396_changeFilterOnSafari(i) {
  var t;
  /^((?!chrome|android).)*safari/i.test(navigator.userAgent) &&
    t396__checkContainBackdropFilter(i) &&
    "IntersectionObserver" in window &&
    ((t = i.querySelector(".tn-atom")),
    new IntersectionObserver(function (t, e) {
      t.forEach(function (t) {
        t.isIntersecting &&
          ((t = t.target),
          e.unobserve(t),
          t396__processBackdropFilterOnImage(i));
      });
    }).observe(t));
}
...
function t396__processBackdropFilterOnImage(t) {
  var e, i;
  t &&
    ((e = t.getAttribute("data-animate-sbs-opts")),
    (i =
      t.getAttribute("data-animate-prx") || t.getAttribute("data-animate-fix")),
    (e = e || i),
    (i = t.classList.contains("t396__elem--backdrop-filter-img-wrappered")),
    (e && i) || !e
...
function t396__updateBackdropFilterOnImage(t) {
  ...
  t &&
    ...
    (n = ""),
    i && ((t = i), (n = window.getComputedStyle(t).webkitBackdropFilter || "")),
    (t.style.webkitBackdropFilter = "none"),
    t396_waitForUploadImg(e, function () {
...
function t396_addTooltip(t, e) {
  (e = t396_getEl(e)) &&
    (e.setAttribute(
      "data-fields",
      "width,height,top,left,container,axisx,axisy,widthunits,heightunits,leftunits,topunits,tipposition"
    ),
    t396_elem__renderView(e),
...
function t396_addForm(t, e, i) {
  ...
  (e = t396_getEl(e)) &&
    (e.setAttribute(
      "data-fields",
      "width,top,left,inputs,container,axisx,axisy,widthunits,leftunits,topunits"
    ),
    (o = e.getAttribute("data-elem-id")),
    (r = e.querySelector(".tn-atom__inputs-textarea")) && (n = r.value),
    t_onFuncLoad("t_zeroForms__init", function () {
      t396_elem__renderView(e),
        t_zeroForms__init(i, o, n),
        t396_elem__renderView(e);
    }));
}
function t396_addGallery(t, e, i) {
  ...
  (e = t396_getEl(e)) &&
    (e.setAttribute(
      "data-fields",
      "width,height,top,left,imgs,container,axisx,axisy,widthunits,heightunits,leftunits,topunits"
    ),
    t396_elem__renderView(e),
...
function t396_elem__getFieldValue(t, e) {
  if ((t = t396_getEl(t))) {
    if (t.classList.contains("tn-group"))
      return t396_group__getFieldValue(t, e);
    var i = t.closest(".t396__artboard"),
      ...
      r =
        (void 0 === window.tn[o] &&
          (t396_initTNobj(n, i),
          t396_switchResolution(n, t396_detectResolution(n))),
        window.tn[o].curResolution),
      a = window.tn[o].curResolution_max,
      l = window.tn[o].screens,
      d =
        r === a
          ? t.getAttribute("data-field-" + e + "-value")
          : t.getAttribute("data-field-" + e + "-res-" + r + "-value");
    if (!d && "" !== d)
      for (var _ = 0; _ < l.length; _++) {
        ...
        if (
          ...
          (d =
            s === a
              ? t.getAttribute("data-field-" + e + "-value")
              : t.getAttribute("data-field-" + e + "-res-" + s + "-value"))
        )
          break;
      }
    return d;
...
function t396_group__renderView(i) {
  ...
  (t = t.split(",")).forEach(function (t) {
    ...
    switch (t) {
      case "left":
        (e = t396_elem__convertPosition__Local__toAbsolute(i, t, e)),
          (i.style.left = parseFloat(e).toFixed(1) + "px");
        break;
      case "top":
        (e = t396_elem__convertPosition__Local__toAbsolute(i, t, e)),
          (i.style.top = parseFloat(e).toFixed(1) + "px");
    }
  });
}
function t396_elem__renderViewOneField(t, e) {
  if ((t = t396_getEl(t))) {
    var i = document.getElementById("allrecords"),
      ...
      n =
        "window" ===
        t396_ab__getFieldValue(t.closest(".t396__artboard"), "upscale");
    if ("yes" !== t.getAttribute("data-scale-off") || !n || "edit" === i) {
      ...
      switch (e) {
        case "left":
          (_ = t396_elem__convertPosition__Local__toAbsolute(t, e, _)),
            (t.style.left = parseFloat(_).toFixed(1) + "px");
          break;
        case "top":
          (_ = t396_elem__convertPosition__Local__toAbsolute(t, e, _)),
            (t.style.top = parseFloat(_).toFixed(1) + "px");
          break;
        case "width":
          switch (
            ((_ = t396_elem__getWidth(t, _)),
            (t.style.width = parseFloat(_).toFixed(1) + "px"),
            (u = t.getAttribute("data-elem-type")))
          ) {
            case "tooltip":
            ...
            case "gallery":
              (o = t396_elem__getFieldValue(t, "borderwidth")),
                (r = t396_elem__getFieldValue(t, "borderstyle")),
                (_ -= 2 * (o = r && o && "none" !== r ? o : 0)),
                (a = Math.round(parseFloat(_)) + "px"),
                (l = t.querySelector(".t-slds__main")),
        ...
        case "container":
          ...
          break;
        case "inputs":
          var u = t.querySelector(".tn-atom__inputs-textarea"),
            _ = u ? u.value : "";
          try {
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  if ((t = t396_getEl(t))) {
    var n = t.closest(".t396__artboard"),
      o = n.getAttribute("data-artboard-recid"),
      r = "ab" + o,
      a = t396_ab__getFieldValue(n, "valign"),
      l = "window" === t396_ab__getFieldValue(n, "upscale"),
      n = document.getElementById("allrecords"),
      d = "edit" === (n ? n.getAttribute("data-tilda-mode") : ""),
      _ = t396_isOnlyScalableBrowser(),
      s = !d && l && _,
      u = !d && l && !_,
      c = t396_elem__getFieldValue(t, "axisy"),
      w = t396_elem__getFieldValue(t, "axisx"),
      g = t396_elem__getFieldValue(t, "container"),
      n =
        t.classList.contains("tn-group") &&
        "physical" === t396_group__getFieldValue(t, "type"),
      p = t.parentNode.closest(".tn-group"),
      m = "physical" === t396_group__getFieldValue(p, "type"),
      h =
        (n && (g = "grid"), (i = parseInt(i)), t396__getCurrentScaleFactor(o));
    switch (e) {
      case "left":
        var f = "grid" === g ? "grid" : "window",
          b = "grid" === g ? window.tn[r].grid_offset_left : 0,
          y = "grid" === g ? window.tn[r].grid_width : window.tn.window_width;
        if (
          ("%" === t396_elem__getFieldValue(t, "leftunits") &&
            (i = t396_roundFloat((y * i) / 100)),
          m)
        ) {
          var F = parseInt(t396_group__getFieldValue(p, "left"), 10);
          i -= F =
            "%" === t396_group__getFieldValue(p, "leftunits")
              ? t396_roundFloat((y * F) / 100)
              : F;
          break;
        }
        !d && l ? "grid" === g && _ && (i *= h) : (i = b + i),
          "center" === w &&
            ((x = t396_elem__getWidth(t)),
            s && "window" !== f && ((y *= h), (x *= h)),
            (i = y / 2 - x / 2 + i)),
          "right" === w &&
            ((x = t396_elem__getWidth(t)),
          ...
          s &&
            "window" !== f &&
            (i += ((x = t396_elem__getWidth(t)) * h - x) / 2);
        break;
      case "top":
        function v(t) {
          var e,
          ...
          return (
            t &&
              ...
              ((e = t396_elem__getWidth(t)),
              (i = t396_elem__getFieldValue(t, "filewidth")),
              (t = t396_elem__getFieldValue(t, "fileheight")),
              i && t && (n = e / (parseInt(i) / parseInt(t)))),
            n
          );
        }
        ...
        if (
          ((f = "grid" === g ? "grid" : "window"),
          (b = "grid" === g ? parseFloat(b) : 0),
          (y = "grid" === g ? parseFloat(y) : parseFloat(x)),
          "%" === t396_elem__getFieldValue(t, "topunits") &&
            (i = y * (i / 100)),
          m)
        ) {
          x = parseInt(t396_group__getFieldValue(p, "top"), 10);
          i -= x =
            "%" === t396_group__getFieldValue(p, "topunits")
              ? t396_roundFloat((y * x) / 100)
              : x;
          break;
        }
        s && "window" !== f && (i *= h),
          (i =
            (b = u && "window" !== f ? ("stretch" === a ? 0 : b / h) : b) + i);
        var A,
          V,
          x = t396_ab__getFieldValue(F, "height_vh"),
          b = t396_ab__getFieldValue(F, "height"),
          S = t396_ab__getHeight(F);
        l && !d && x && (A = parseInt(b, 10) * h),
          "center" === c &&
            ((V = v(t)),
            s &&
              "window" !== f &&
            ...
            d ||
              ...
              "window" === f ||
              "stretch" !== a ||
              ((y = A ? (S < A ? A : S) : F.clientHeight), (y /= h)),
            (i = y / 2 - V / 2 + i)),
          "bottom" === c &&
            ((V = v(t)),
            s &&
          ...
          s &&
            "window" !== f &&
            ((x = ((V = v(t)) * h - V) / 2), (i += x = Math.round(x)));
    }
    return i;
  }
}
function t396_elem_fixLineHeight(t) {
  ...
  "text" !== t.getAttribute("data-elem-type") ||
    ...
    ((i = t.closest(".t396__group")) && i.style.zoom) ||
    ...
    (o = i && n ? t396_elem__getCorrectStylesForSafari(t, "lineHeight") : o) &&
      !isNaN(o) &&
      (e.style.lineHeight = Math.round(o) + "px"));
}
function t396_elem__getCorrectStylesForSafari(t, e) {
  var i = t.querySelector(".tn-atom"),
    ...
    e =
      ...
      (i.style.fontSize = ""),
      (t.style.zoom = ""),
      parseFloat(window.getComputedStyle(i)[e]));
  return (
    (i.style.webkitTextSizeAdjust = o),
    (i.style.fontSize = r),
    n && (t.style.zoom = n),
    e
  );
  ...
  if (t) {
    var i = t.getAttribute("data-artboard-recid"),
      ...
      o =
        (void 0 === window.tn[n] &&
          (t396_initTNobj(i, t),
          t396_switchResolution(i, t396_detectResolution(i))),
        window.tn[n].curResolution),
      r = window.tn[n].curResolution_max,
      a = window.tn[n].screens,
      l =
        o === r
        ...
        if (
          ...
          null !==
            (l =
              _ === r
                ? t.getAttribute("data-artboard-" + e)
                : t.getAttribute("data-artboard-" + e + "-res-" + _))
        )
          break;
      }
    return l;
...
function t396_group__getFieldValue(t, e) {
  if (t) {
    var i =
        "ab" + t.closest(".t396__artboard").getAttribute("data-artboard-recid"),
      n = window.tn[i].curResolution,
      o = window.tn[i].curResolution_max,
      r = window.tn[i].screens,
      i = ["widthmode", "heightmode", "flex"].includes(e) ? "" : "-value",
      a =
        n === o
          ? t.getAttribute("data-group-" + e + i)
          : t.getAttribute("data-group-" + e + "-res-" + n + i);
    if (null === a)
      for (var l = 0; l < r.length; l++) {
        ...
        if (
          ...
          null !==
            (a =
              d === o
                ? t.getAttribute("data-group-" + e + "-value")
                : t.getAttribute("data-group-" + e + "-res-" + d + "-value"))
        )
          break;
      }
    return a;
...
function t396_allgroups__renderViewAutolayout(t) {
  var e, i;
  t &&
    t.classList.contains("t396__group-flex") &&
    ((e = t396_group__getFieldValue(t, "widthmode")),
...
function t396_ab__getHeight(t, e) {
  ...
  return (
    t &&
      ((t = parseFloat(t)),
      isNaN(t) || (e < (t = (window.tn.window_height * t) / 100) && (e = t))),
    e
  );
}
  ...
  return (
    ...
    (e =
      "%" === t396_elem__getFieldValue(t, "widthunits")
        ? "window" === t396_elem__getFieldValue(t, "container")
          ? (window.tn.window_width * e) / 100
...
function t396_elem__getHeight(t, e) {
  (t = t396_getEl(t)),
    (e = e || t396_elem__getFieldValue(t, "height")),
    (e = parseFloat(e));
  var i,
    n,
    o = t.getAttribute("data-elem-type");
  return (
    "shape" === o ||
    "video" === o ||
    "html" === o ||
    ...
    "button" === o
      ? "%" === t396_elem__getFieldValue(t, "heightunits") &&
        ((i = (n = t.closest(".t396__artboard"))
          ? n.getAttribute("data-artboard-proxy-min-height")
          : "0"),
...
function t396_getEl(t) {
  return window.jQuery && t instanceof jQuery
    ? t.length
      ? t.get(0)
      : null
    : t;
