...
function t_onFuncLoad(t, e, n) {
  ...
  if (a(t) && r()) e();
    ...
    setTimeout(function o() {
      ...
      a(t) && r()
        ? e()
        : ("complete" === document.readyState && d - l > i && !a(t) && s(),
          setTimeout(o, n || 100));
    });
  }
}
      ...
      if (!e.classList.contains("t975")) {
        var n = window.getComputedStyle(e),
          ...
          a =
            ...
            o === window.innerWidth - t.scrollBarWidth + "px" ||
            "100vw" === o,
          l =
            "100%" === r ||
            ...
            "auto" === r ||
            "100vh" === r;
        ("fixed" === i || ("absolute" === i && a && !l)) &&
          t.fixedElements.push({ el: e, computedStyle: n });
      }
    });
}
function t_scrollBarWidthCompensator__init() {
  if (!window.isMobile) {
    window.scrollBarWidthCompensator ||
      t_scrollBarWidthCompensator__setObject();
    var t = window.scrollBarWidthCompensator;
    if (
      ((t.scrollBarWidth = Math.abs(
        window.innerWidth - document.documentElement.clientWidth
      ...
      Array.prototype.forEach.call(t.fixedElements, function (e) {
        ...
        if (
          ...
          if ("fixed" === r || "absolute" === r) {
            ...
            a.indexOf("ms") + 1
              ? ((a = parseInt(a.replace("ms", ""), 10)), i.push(a))
              : a.indexOf("s") + 1 &&
                ((a = 1e3 * parseFloat(a.replace("s", ""))), i.push(a));
            ...
            var h =
              ...
              p =
                ...
                "auto" === s ||
                "100vh" === s;
            (!l && 0 !== l) || "auto" === n.style.right || "absolute" === r || h
              ? h &&
                !p &&
                (n.style.width = "calc(100vw - " + t.scrollBarWidth + "px)")
  ...
  t &&
    ...
    document.body.hasAttribute("data-tilda-initial-padding-right")
      ? ((document.body.style.paddingRight = document.body.getAttribute(
          "data-tilda-initial-padding-right"
        )),
...
(window.browserLang = (
  ...
  t_onReady(function () {
    setTimeout(function () {
      ...
      if (
        ...
        (document.getElementById("tildacopy") || e) &&
        ...
        for (
          var i = document.body.childNodes, o = [], r = 0;
          r < i.length;
          r++
        ) {
          var a = i[r];
        ...
        for (var r = 0; r < o.length; r++)
          -1 !== o[r].nodeValue.indexOf("'t remove this l") &&
            document
  ...
  t_onReady(function () {
    ...
    if (
      ...
      for (var e = document.querySelectorAll(".r"), n = 0; n < e.length; n++) {
        var i,
          o = (i = e[n]).getAttribute("style");
        o &&
          -1 !== o.indexOf("background-color") &&
          i.setAttribute("data-animationappear", "off");
      }
      for (
        ...
        var i,
          a = (i = r[n]).getBoundingClientRect().top + window.pageYOffset,
          ...
          var c = 0,
            ...
            h = setInterval(function () {
              ...
              for (var t = 0; t < s.length; t++) {
                var e;
                "yes" === s[t].getAttribute("data-hiding-completed") &&
                  (c += 1);
              }
    ...
    var g = document.querySelector(".t-tildalabel"),
      w;
    (w = m
      ? Math.max(m.scrollHeight, m.offsetHeight, m.clientHeight, p.offsetHeight)
      : p.offsetHeight) +
      70 <
    window.innerHeight
      ? g && (g.style.display = "none")
      : g && g.setAttribute("style", "display: block !important");
  }),
  (function () {
    function t() {
    ...
    function e() {
      ...
      for (var r = 0; r < e.length; r++) {
        ...
        (o = getComputedStyle(a).display),
          ...
          (i = parseInt(i)) <= n &&
            (t <= n && t > i
              ? "block" !== o && (a.style.display = "block")
              : "none" !== o && (a.style.display = "none"));
      }
    }
    t_onReady(function () {
      t(),
  ...
  (function () {
    ...
    function e() {
      for (
        var t = document.querySelectorAll(".t-cover__carrier"), e = 0, n = 0;
        n < t.length;
        n++
      ) {
        var i, o;
      ...
      for (var n = 0; n < h.length; n++) {
        var i, o;
        (o = (i = h[n]).style).height.indexOf("vh") > -1 &&
          ((e = parseInt(o.height) / 100), (d = p + "px"), (o.height = d));
      }
    }
    function n() {
        ...
        for (
          ...
          if (h > e) {
            if (
              ...
              "false" ===
                u.parentNode.getAttribute("[data-auto-correct-mobile-width]")
            )
              return;
            console.log(
      ...
      for (
        ...
        if (o) {
          ...
          if (document.documentElement.clientWidth > t)
            (a = (a = o.replace("lineheight", "line-height")).replace(
              "fontsize",
              "font-size"
            )),
      ...
      (t && screen.width < 480)
        ? (t_onReady(function () {
            for (
              ...
              var o = t[n];
              parseInt(getComputedStyle(o).fontSize.replace("px", "")) > 26 &&
        ...
        : (window.innerWidth < 900 ||
          ...
          t_onReady(function () {
            for (
              ...
              var i = t[n];
              parseInt(getComputedStyle(i).fontSize.replace("px", "")) > 30 &&
