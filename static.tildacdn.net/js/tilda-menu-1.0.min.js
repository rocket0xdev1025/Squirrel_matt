...
function t_menu__updateSectionsOffsets(e) {
  e.forEach(function (e) {
    ...
    e.getAttribute("data-offset-top") !== t.toString() &&
      e.setAttribute("data-offset-top", t);
  });
}
function t_menu__getSectionByHref(e) {
  if (e) {
    ...
    ("number" == typeof i ||
      "number" == typeof (i = -1 !== r.indexOf("/") && r.indexOf("/"))) &&
      (r = r.slice(i + 1));
...
function t_menu__showFixedMenu(e, t) {
  var n,
    r = [".t280", ".t282", ".t450", ".t451", ".t466", ".t453"].some(function (
      e
    ) {
      return e === t;
    });
  if (!(window.innerWidth <= 980) || r) {
    ...
    Array.prototype.forEach.call(o, function (e) {
      ...
      if (t) {
        -1 !== t.indexOf("vh") &&
          (t = Math.floor(window.innerHeight * (parseInt(t) / 100))),
          (t = parseInt(t, 10));
        var n = e.clientHeight;
        "number" == typeof t && window.pageYOffset >= t
          ? e.style.transform === "translateY(-" + n + "px)" &&
            t_menu__slideElement(e, n, "toBottom")
...
function t_menu__interactFromKeyboard(e) {
  ...
  if (t) {
    var n = t.querySelectorAll(".t-menu__list > li > a"),
      ...
      s = 0,
      u,
      t_menu__focusOnCurrentMenuItem = function (e) {
    ...
    Array.prototype.forEach.call(n, function (e) {
      ...
      t_menu__focusOnMenuItem(e),
        ...
        !e.parentNode.querySelector(".t-menusub__menu") ||
          window.isMobile ||
          "ontouchend" in document ||
          t_menu__clickOnMenuItem(e);
    }),
