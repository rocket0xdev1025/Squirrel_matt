function t_animationSBS__checkVisibilityPage() {
  "visible" === document.visibilityState &&
    (t_animationSBS__onReady(t_animationSBS__init),
    document.removeEventListener(
      "visibilitychange",
      t_animationSBS__checkVisibilityPage
    ));
}
...
function t_animationSBS__init() {
  var t = document.getElementById("allrecords"),
    e =
      (e = t ? "edit" === t.getAttribute("data-tilda-mode") : null) ||
      Boolean(document.getElementById("for_redactor_toolbar"));
  /Bot/i.test(navigator.userAgent) ||
    document.documentMode < 11 ||
    e ||
    (document.querySelector('[data-animate-sbs-event="scroll"]') &&
      (t.style.overflowX = "hidden"),
    t_animationSBS__isZeroBlocksRendered(function () {
      t_animationSBS_isInstagramRendered(function () {
        t_animationSBS__setAutoScaleInfo(),
          t_animationSBS__wrapAndUpdateEls(
            Array.prototype.slice.call(
              document.querySelectorAll("[data-animate-sbs-event]")
            )
          ),
          t_animationSBS__initAllRes(e);
      });
    }));
}
function t_animationSBS__setAutoScaleInfo() {
  var t, e, n;
  void 0 === window.shouldUseScaleFactor &&
    ...
    (window.shouldUseScaleFactor = !window.isOnlyScalable && !t && n <= 127));
}
  ...
  (a = a.length ? a : t_animationSBS__getArtboards("121")).length &&
    ...
    a.every(function (t) {
      ...
      : document.querySelectorAll(
          'script[src*="tilda-blocks-2"], script[src*="tilda-blocks-1"]'
        ).length
...
function t_animationSBS__getArtboards(t) {
  return Array.prototype.slice.call(
    document.querySelectorAll(
      '.r[data-record-type="' +
        t +
        '"]:not(.t397__off):not(.t395__off):not(.t400__off) .t396__artboard'
    )
  );
}
  ...
  window.animationSBS__isIOS && -1 !== navigator.userAgent.indexOf("Instagram")
    ? (e = setTimeout(function () {
        ...
        window.innerHeight > window.innerWidth
          ? t_animationSBS_isInstagramRendered(t)
          : (clearTimeout(e), t());
      }, 100))
    : t();
}
function t_animationSBS__wrapAndUpdateEls(t) {
  ...
  t.forEach(function (t) {
    var e,
      ...
      i,
      a,
      r = t.querySelector(".tn-molecule, .tn-atom");
    r &&
      (-1 === navigator.userAgent.indexOf("Chrome") &&
        ((r.style.WebkitBackfaceVisibility = "hidden"),
        (r.style.backfaceVisibility = "hidden")),
      (e = t.querySelector(".tn-atom__sbs-anim-wrapper")),
      (n = t_animationSBS__getAnimOptions(t, "published", null)),
      !e &&
        n &&
        ((n = getComputedStyle(r).display),
        r.classList.contains("tn-molecule") &&
          "flex" !== n &&
          (r.style.display = "inherit"),
        (n = t_animationSBS__getScaleWrapper(r)),
        (i = t.style.transform) &&
          -1 !== i.indexOf("matrix(") &&
          (t_animationSBS__wrapEl(n || r, "tn-atom__sbs-transform-wrapper"),
          ((a = t.querySelector(
            ".tn-atom__sbs-transform-wrapper"
          )).style.transform = i),
          (t.style.transform = "")),
        t_animationSBS__wrapEl(
          (a = t.querySelector(".tn-atom__sbs-transform-wrapper")) || n || r,
...
function t_animationSBS__getScaleWrapper(t) {
  if (!t) return null;
  var e = t.closest(".t396__group"),
    n = t.classList.contains("tn-atom");
  return e && n ? null : t.closest(".tn-atom__scale-wrapper");
}
...
function t_animationSBS__updateStylesAfterWrapping(e, n, i) {
  var a = e.getAttribute("data-elem-type"),
    r = getComputedStyle(e),
    t = r.getPropertyValue("border-radius"),
    t =
      (("shape" !== a && "button" !== a && "image" !== a) ||
        !parseInt(t, 10) ||
    ...
    o =
      ((t = (t = t.map(function (t) {
        ...
        if (
          "none" !==
            (n = "none" !== n && "" !== n ? n : r.getPropertyValue(e)) &&
          "" !== n
        )
          return { filter: t, webkitFilter: e, value: n };
      })).filter(function (t) {
        return t;
      })),
      e.querySelector(".tn-molecule, .tn-atom")),
    s = getComputedStyle(o).transform,
    l = document.createEvent("Event"),
    t =
      (l.initEvent("backdropFilterImgWrappered", !0, !0),
      t.forEach(function (t) {
        window.t_animationSBS__isFirefox &&
          ...
          "image" === a &&
            ...
            (e.dispatchEvent(l),
            e.classList.add("t396__elem--backdrop-filter-img-wrappered")),
          i &&
            "backdrop-filter" === t.filter &&
            ((o.style[t.webkitFilter] = "inherit"),
            (o.style[t.filter] = "inherit")),
          "none" === s && (o.style.transform = "translateZ(0)");
      }),
      t.some(function (t) {
        return "backdrop-filter" === t.filter;
      }));
  i && t && t_animationSBS__chromeFixBackdropFilter(o, n);
}
function t_animationSBS__chromeFixBackdropFilter(t, e) {
  ...
  "rgba(0, 0, 0, 0)" !== i &&
    ...
    (n = t_animationSBS__processBoxShadowRGB(n, a)) &&
      ((e.style.boxShadow = n), (t.style.boxShadow = "none")),
    (e.style.backgroundColor = "rgba(" + i + "," + a + ")"),
    (t.style.opacity = "1"),
    (t.style.backgroundColor = "transparent"),
    (t.style.backdropFilter = "initial"),
    (t.style.WebkitBackdropFilter = "initial"));
}
function t_animationSBS__processBoxShadowRGB(t, e) {
  if (!t) return !1;
  if ((-1 === t.indexOf("rgba") && -1 === t.indexOf("rgb")) || "1" === e)
    return !1;
...
function t_animationSBS__initAllRes(t) {
  ...
  a.elements.length &&
    ...
    "ResizeObserver" in window
      ? t_animationSBS__createResizeObserver(
          {
            breakpoints: (i = t_animationSBS__getAllBreakpoints()),
            currentRes: t_animationSBS__getCurrentRes(i, t),
            isMobile: t,
          },
          r
        )
    ...
    t_animationSBS__triggerNoScrollAnimation(a, e),
    document.querySelectorAll('[data-animate-sbs-event="scroll"]').length &&
      (t_animationSBS__triggerScrollAnim(a), t_animationSBS__checkFrame(a)),
...
function t_animationSBS__getAnimElsOnView(t) {
  return t.filter(function (t) {
    ...
    return (
      "intoview" === t.getAttribute(e) || "blockintoview" === t.getAttribute(e)
    );
  });
}
function t_animationSBS__getAllBreakpoints() {
  var t = Array.prototype.slice.call(
      document.querySelectorAll(".r .t396__artboard")
    ),
    n = [];
  return (
    t.forEach(function (t) {
  ...
  new ResizeObserver(function (t) {
    t.forEach(function (t) {
      ...
      document.body.classList.contains("t-body_scroll-locked") ||
        ...
        ((e = t_animationSBS__getCurrentRes(n.breakpoints, n.isMobile)),
        (t.contentRect.height === r && n.currentRes === e) ||
          ((n.currentRes = e), (r = a[0].height), i()));
    });
  }).observe(document.body);
}
function t_animationSBS__changeElValues(e) {
  e.elements.forEach(function (t) {
    t_animationSBS__setAndCacheElTopPos(t, e),
      "scroll" === t.animType && t_animationSBS__updateStepsValues(t);
  });
}
...
function t_animationSBS__checkPosChanges(t) {
  ...
  return (
    t_animationSBS__updateAnimatedObjectState(
      t,
      "scrollTop",
      (n = n < 0 && window.t_animationSBS__isSafari ? 0 : n)
    ),
    e !== n
  );
}
function t_animationSBS__triggerScrollAnim(n) {
  n.elements.forEach(function (t) {
    var e;
    "scroll" === t.animType &&
      (t_animationSBS__scrollAnimationCheckSteps(
        n,
        t,
        (e = {
          opacity: 1,
      ...
      t_animationSBS__scrollAnimationUpdateTransform(t, e));
  });
}
function t_animationSBS__scrollAnimationCheckSteps(l, _, c) {
  _.steps.forEach(function (t, e) {
    var n = l.scrollTop + _.triggerOffset,
      i = t_animationSBS__getZoom(_),
      a = (_.scaledDifference && (n += _.scaledDifference), n >= t.start),
      r = n < t.start,
      o = t.end <= n,
      s = t.end > n;
    a &&
      s &&
      ((t.state = "started"),
      _.wrapperEl && (_.wrapperEl.style.willChange = "transform"),
      (a = n - t.start),
      (s = 0 === t.dist ? 1 : a / t.dist),
      (c.prevUnfixedDist = t.prevUnfixedDist),
      t_animationSBS__scrollAnimationCalcStepStyles(c, t, s, e, i)),
      o &&
        ((t.state = "finished"),
        _.wrapperEl && (_.wrapperEl.style.willChange = ""),
        t_animationSBS__scrollAnimationCalcStepStyles(c, t, 1, e, i)),
      !r ||
        ("started" !== t.state && "finished" !== t.state) ||
        ((t.state = "unactive"),
        _.wrapperEl && (_.wrapperEl.style.willChange = ""),
        t_animationSBS__scrollAnimationCalcStepStyles(c, t, 0, e, i));
  }),
    _.classList.remove("t396__elem--anim-hidden"),
    _.steps[1] &&
      0 === _.steps[1].dist &&
      0 === _.steps[1].styles.opacity &&
      "unactive" === _.steps[1].state &&
      (c.opacity = 0);
}
function t_animationSBS__scrollAnimationCalcStepStyles(t, e, n, i, a) {
  if (
    (!0 === e.styles.fix &&
      "started" === e.state &&
      ((t.fix = !0), (t.fixedShiftY = 0)),
    !0 === e.styles.fix &&
      "finished" === e.state &&
      ((t.fix = !1), (t.fixedShiftY += e.dist / a)),
    !0 === e.styles.fix && "unactive" === e.state)
  ) {
...
function t_animationSBS__scrollAnimationUpdateTransform(t, e) {
  ...
  t.wrapperEl &&
    ...
    (r = getComputedStyle(t).willChange),
    (i = window.isOnlyScalable),
    !0 === e.fix &&
      "fixed" !== t.wrapperEl.style.position &&
      ((a = t.triggerOffset - e.prevUnfixedDist),
      i || (a /= n),
      t.scaledDifference && (a += t.scaledDifference),
      (t.wrapperEl.style.top = a + "px"),
      (t.wrapperEl.style.position = "fixed"),
      r && "auto" !== r && (t.style.willChange = "unset"),
      t.zIndex && (t.wrapperEl.style.zIndex = t.zIndex)),
    !1 === e.fix &&
      "fixed" === t.wrapperEl.style.position &&
      ((t.wrapperEl.style.position = ""),
      (t.wrapperEl.style.top = ""),
      (t.wrapperEl.style.zIndex = ""),
      t.zIndex && (t.style.zIndex = t.zIndex),
      (t.style.willChange = "")),
    ...
    e.translateX &&
      ((r = e.translateX),
      i && (r *= n),
      (a += "translateX(" + r.toFixed(2) + "px)")),
    (0 === e.translateY && 0 === e.fixedShiftY) ||
      ((r = e.translateY + e.fixedShiftY),
      i && (r *= n),
      (a += "translateY(" + r.toFixed(2) + "px)")),
    (1 === e.scaleX && 1 === e.scaleY) ||
      (a += "scale(" + e.scaleX + "," + e.scaleY + ")"),
    0 !== e.rotate && (a += "rotate(" + e.rotate + "deg)"),
    (t.wrapperEl.style.transform = a || "scale(1)"));
}
    ...
    (t.elements.forEach(function (t) {
      ...
      "scroll" !== t.animType &&
        ...
        i &&
          ...
          ("hover" !== t.animType && "click" !== t.animType) ||
            (t.loop && "loopwithreverse" !== t.loop) ||
            (a += t_animationSBS__generateKeyframes__getReverseAnim(t))));
    }),
    a)
  ) {
...
function t_animationSBS__generateKeyframes__combineObjects(a, r, o, s) {
  a.forEach(function (t, e) {
    ...
    "{}" !== JSON.stringify(i.styles) &&
      ((i.time = +t.time || 0),
      e !== a.length - 1 && (i.ease = a[e + 1].ease),
      r.push(i),
      (o.timeDuration += i.time));
  });
}
function t_animationSBS__generateKeyframes__correctFrames(s) {
  s.forEach(function (t, e) {
    ...
    for (n in t.styles)
      a ||
        n in o.styles ||
        t_animationSBS__generateKeyframes__addStyleToKeyframe(t, o, n, 0),
        i ||
          (n in r.styles
            ? ("moveX" !== n && "moveY" !== n && "rotate" !== n) ||
              t_animationSBS__generateKeyframes__recalculateValue(t, r, n)
...
function t_animationSBS__generateKeyframes__addStyleToKeyframe(t, e, n, i) {
  ("blur" !== n && "rotate" !== n && "moveX" !== n && "moveY" !== n) ||
    (e.styles[n] = 0 === i ? 0 : t.styles[n]),
    ("opacity" !== n && "scaleX" !== n && "scaleY" !== n) ||
      (e.styles[n] = 0 === i ? 1 : t.styles[n]);
}
...
function t_animationSBS__generateKeyframes__countPercent(t, e) {
  for (var n = 0; n < t.length; n++) {
    ...
    if (0 === n)
      0 === e.timeDuration
        ? (a.percent = 0)
        : ((i = ((100 * a.time) / e.timeDuration).toFixed(2)),
      ...
      if (0 === e.timeDuration) a.percent = 0;
        ...
        if (
          ((i = ((100 * a.time) / e.timeDuration + r).toFixed(2)),
          100 === parseInt(i, 10) && n === t.length - 2 && 0 !== n)
        )
          continue;
        a.percent = parseInt(i, 10);
      }
...
function t_animationSBS__generateKeyframes__correctOpacityOnFirstStep(t, e) {
  var n = e[1];
  t && t.classList.remove("t396__elem--anim-hidden"),
    n &&
      0 === n.time &&
      0 === n.styles.opacity &&
      ((n = t ? t.querySelector(".tn-atom__sbs-anim-wrapper") : null) &&
        (n.style.opacity = "0"),
      (e[0].styles.opacity = 0));
}
function t_animationSBS__generateKeyframes__getTxtStyles(e, t) {
  ...
  return (
    t.forEach(function (t) {
      t.changes ||
        (t.changes = t_animationSBS__generateKeyframes__getFrameChanges(e, t)),
        (n +=
...
function t_animationSBS__generateKeyframes__getFrameChanges(t, e) {
  var n = "",
    ...
    a = { x: 1, y: 1, changed: !1 },
    r = 1;
  window.isOnlyScalable && (r = t_animationSBS__getZoom(t));
  var o,
    t = t_animationSBS__getScaleWrapper(
      t.querySelector(".tn-molecule, .tn-atom")
    );
  for (o in (1 === r || t || (r = 1), e.styles))
    switch (o) {
      case "opacity":
        n += "opacity:" + e.styles.opacity + ";";
        break;
      case "scaleX":
        (a.x = e.styles.scaleX), (a.changed = !0);
        break;
      case "scaleY":
        (a.y = e.styles.scaleY), (a.changed = !0);
        break;
      case "moveX":
        i += "translateX(" + Math.round(e.styles.moveX * r) + "px)";
        break;
      case "moveY":
        i += "translateY(" + Math.round(e.styles.moveY * r) + "px)";
        break;
      case "rotate":
        i += "rotate(" + e.styles.rotate + "deg)";
    }
  if (
    (!0 === a.changed && (i += "scale(" + a.x + "," + a.y + ")"),
    "" !== i && (n += "transform:" + i + ";"),
    void 0 !== e.ease)
  )
    switch (((n += "animation-timing-function:"), e.ease)) {
      case "easeIn":
        n += "ease-in;";
        break;
      case "easeOut":
      ...
      case "easeInOut":
        ...
        break;
      case "bounceFin":
        n += "cubic-bezier(0.34,1.61,0.7,1);";
        break;
      default:
        n += "" === e.ease.trim() ? "linear;" : e.ease + ";";
    }
  return n;
}
function t_animationSBS__generateKeyframes__getFinalCss(t, e, n) {
  ...
  i +=
    ...
    a +
    " " +
    (0 === e.timeDuration ? 1e-5 : e.timeDuration) +
    "s";
  ...
  return (
    ...
    (i += " linear"),
    r
      ? "loopwithreverse" === t.loop && (i += " alternate")
      : (i += " forwards"),
    (i +=
...
function t_animationSBS__generateKeyframes__getReverseAnim(t) {
  var e = t.classList.contains("tn-group"),
    n = t.getAttribute(e ? "data-group-id" : "data-elem-id") || t.id,
    e = e ? '[data-group-id="' + n + '"]' : '[data-elem-id="' + n + '"]',
    n = "";
  return (
    (n +=
      "#" +
      (t.closest(".t-rec") ? t.closest(".t-rec").getAttribute("id") : "") +
      " ") +
    (e +
...
function t_animationSBS__getAnimOptions(e, t, n) {
  ...
  var i = ["sbs", "opts"],
    a =
      ((n = n || ("edit" === t ? i.join("") : i.join("-"))),
      "edit" === t ? "field" : "animate"),
    r = "edit" === t ? "-value" : "",
    i =
      "y" ===
      e.getAttribute(
        "edit" === t ? "data-field-animmobile-value" : "data-animate-mobile"
      ),
  ...
  if (!i && "edit" !== t && o.res < 1200)
    return (
      (e.style.transition = "none"),
      e.classList.remove("t396__elem--anim-hidden"),
      ""
    );
  ...
  return (
    ...
    (o.breakpoints.forEach(function (t) {
      t <= o.res ||
        l ||
        ((t = t_animationSBS__generateAttr(a, n, r, t)),
        (l = e.getAttribute(t)));
    }),
    l || e.getAttribute(s) || "")
  );
...
function t_animationSBS__getResOpts(t) {
  ...
  return t && window.tn["ab" + t]
    ? {
        res: window.t396_detectResolution
          ? t396_detectResolution(t)
          : window.tn["ab" + t].curResolution,
...
function t_animationSBS__cacheAndSetData(n) {
  n.elements.forEach(function (i) {
    ...
    ("scroll" === i.animType &&
      e &&
      "fixed" === t396_ab__getFieldValue(e, "pos")) ||
      ((e = n.isEditMode
        ? "data-field-sbsevent-value"
      ...
      (i.triggerElems = t_animationSBS__getAnimOptions(
        i,
        "published",
        "sbs-trgels"
      )),
      (i.wrapperEl = i.querySelector(".tn-atom__sbs-anim-wrapper")),
      (e = t_animationSBS__getAnimOptions(
        i,
        n.isEditMode ? "edit" : "published",
        null
      )),
      (i.status = e ? "active" : "innactive"),
      "innactive" !== i.status &&
        (-1 !== e.indexOf("fixed") &&
          (i.zIndex = getComputedStyle(i).getPropertyValue("z-index")),
        (e = e.replace(/'/g, '"')),
        t_animationSBS__addDelayToSteps((e = JSON.parse(e))),
        (t = n.isEditMode
          ? "data-field-sbsloop-value"
        ...
        e.forEach(function (t, e) {
          ...
          (n.styles = t_animationSBS__createStepStyles(t)),
            "scroll" === i.animType
              ? ((n.prevUnfixedDist = r),
                (n.dist = t.di * a),
                !1 === n.styles.fix && (r += n.dist),
                (n.start = 0 === e ? i.topOffset : i.steps[e - 1].end),
                (n.end = n.start + n.dist))
              : ((n.time = t.ti), (n.ease = t.ea)),
            i.steps.push(n);
        }),
        i.wrapperEl &&
          !i.wrapperEl.id &&
          t_animationSBS__generateUniqueIDForEl(i),
  ...
  var t = n.elements.filter(function (t) {
    return (
      "innactive" === t.status &&
        (t.wrapperEl && t.wrapperEl.removeAttribute("style"),
        t.wrapperEl && (t.wrapperEl.style.display = "table"),
        t.wrapperEl && (t.wrapperEl.style.width = "inherit"),
        t.wrapperEl && (t.wrapperEl.style.height = "inherit")),
      "innactive" !== t.status
    );
  });
...
function t_animationSBS__generateUniqueIDForEl(t) {
  var e = t.closest(".t396__artboard, .tn-artboard"),
    ...
    e =
      (e &&
        (n =
          e.getAttribute("data-record-id") ||
          e.getAttribute("data-artboard-recid")),
      t.getAttribute("data-elem-id") ||
        t.getAttribute("data-group-id") ||
        t.id);
  (t.uniqueID = "sbs-" + n + "-" + e), (t.wrapperEl.id = t.uniqueID);
}
...
function t_animationSBS__updateStepsValues(n) {
  n.steps.forEach(function (t, e) {
    (t.start = 0 === e ? n.topOffset : n.steps[e - 1].end),
      (t.end = t.start + t.dist);
  });
}
function t_animationSBS__setAndCacheElTopPos(e, t) {
  ...
  t.isEditMode ||
    ...
    (a = e.closest(".t396__group")) &&
      a !== e &&
      (t += parseInt(a.style.top, 10) || 0),
    ("scroll" !== e.animType && "intoview" !== e.animType) ||
    ...
    (e.parentRecTopPos = n),
    (e.topOffset = n + t + a),
    t_animationSBS__setScaledDifference(e, i),
    t_animationSBS__setTriggerOffset(e));
}
function t_animationSBS__setScaledDifference(t, e) {
  var n;
  !t.scaledDifference &&
    window.isOnlyScalable &&
    "fixed" !== t.wrapperEl.style.position &&
    ((n = t.wrapperEl ? t.wrapperEl.getBoundingClientRect().height : 0),
    (e = Math.abs((n * e - n) / 2)),
    (e = Math.round(e)),
    (t.scaledDifference = e));
}
function t_animationSBS__addDelayToSteps(t) {
  for (var e = 0; e < t.length; e++) {
    var n,
      i = t[e];
    0 !== e &&
      (parseInt(i.dd, 10) || parseInt(i.dt, 10)) &&
      ((n = Object.create(t[e - 1])),
      void 0 !== i.dt ? (n.ti = i.dt) : (n.di = i.dd),
      t.splice(e, 0, n),
      e++);
  }
}
...
function t_animationSBS__setTriggerOffset(t) {
  var e = window.innerHeight,
    n = t_animationSBS__getZoom(t);
  (t.triggerOffset = parseInt(
    t_animationSBS__getAnimOptions(t, "published", "sbs-trgofst"),
    10
  )),
    (!window.isOnlyScalable && "scroll" !== t.animType) ||
      (t.triggerOffset *= n),
    ...
    (0.5 !== t.trigger && 1 !== t.trigger) ||
      ...
      ("intoview" === t.animType || "scroll" === t.animType) &&
        ...
        ((t.triggerOffset = t.topOffset),
        t.scaledDifference &&
          (t.triggerOffset < 0 || t.triggerOffset === t.scaledDifference) &&
          (t.scaledDifference = 0)),
      "blockintoview" === t.animType &&
        t.triggerOffset > t.parentRecTopPos &&
        t.triggerOffset <= e * t.trigger &&
        (t.triggerOffset = t.parentRecTopPos));
}
function t_animationSBS__triggerNoScrollAnimation(t, e) {
  t_animationSBS__processElsIntoView(t, e),
    t_animationSBS__removeHoverClickTriggers(t),
    t_animationSBS__initClickTriggers(t),
    t_animationSBS__initHoverTriggers(t);
}
function t_animationSBS__processElsIntoView(t, e) {
  t_animationSBS__updateIntoViewElsState(e);
  var n = 0;
  t_animationSBS__setKeyForAnimatedObject(
    t,
    "onScrollUpdateElsIntoView",
    function () {
      n =
        n ||
        setTimeout(function () {
...
function t_animationSBS__removeHoverClickTriggers(t) {
  ...
  e.length &&
    ...
    t.clickedTriggerEls.forEach(function (t) {
      t.removeEventListener("click", t_animationSBS__initClickCallback),
        t_animationSBS__removeTriggerList(t, "click");
    }),
...
function t_animationSBS__removeTriggerList(t, e) {
  t["triggerList-on-" + e] && (t["triggerList-on-" + e] = []),
    t["triggerOnceList-on-" + e] && (t["triggerOnceList-on-" + e] = []);
}
function t_animationSBS__initClickTriggers(t) {
  ...
  n.length &&
    ...
    (n = Array.prototype.slice.call(
      document.querySelectorAll(".js-sbs-anim-trigger_click")
    )).length &&
      (document.getElementById("js-sbs-anim-trigger-styles") ||
        (((e = document.createElement("style")).id =
          "js-sbs-anim-trigger-styles"),
        (e.textContent = ".js-sbs-anim-trigger_click { cursor: pointer; }"),
        document.head.insertAdjacentElement("beforeend", e)),
      (t.clickedTriggerEls = n).forEach(function (t) {
        t_animationSBS__preventAnimatedParentTrigger(t),
          t.removeEventListener("click", t_animationSBS__initClickCallback),
          t.addEventListener("click", t_animationSBS__initClickCallback);
      })));
}
  ...
  (t.length || e.length) &&
    ...
    t.forEach(function (t) {
      (t.classList.contains("t-sbs-anim_started") &&
        !t.classList.contains("t-sbs-anim_reversed")
        ? t_animationSBS__setActionOnEnd
        : t_animationSBS__setActionOnStart)(t);
    }));
}
    ...
    (t.hoverTriggerEls = e).forEach(function (t) {
      t_animationSBS__preventAnimatedParentTrigger(t),
        window.animationSBS__isIOS
          ? (t.removeEventListener("click", t_animationSBS__initHoverTrigger),
            t.addEventListener("click", t_animationSBS__initHoverTrigger))
...
function t_animationSBS__initHoverTrigger(t) {
  ...
  function a(t) {
    e.closest(".t396__elem") !== t.target.closest(".t396__elem") &&
      (t_animationSBS__actionOnEnd(n),
      e.classList.remove("t-hover-mob-active"),
  ...
  ((n && n.length) || (i && i.length)) &&
    ...
    n &&
      ...
      "click" !== t.type ||
        ...
        (setTimeout(function () {
          t_animationSBS__actionOnStart(n),
            e.classList.add("t-hover-mob-active");
        }),
        setTimeout(function () {
      ...
      ? ((i = i ? i.split(",") : []),
        ...
        i.forEach(function (t) {
          ...
          t_animationSBS__processTriggersElemList(
            document.querySelector(".tn-elem__" + t + ", .tn-group__" + t),
            e,
            a
          );
        }))
      : t_animationSBS__processTriggersElemList(
          e.querySelector(".tn-atom__sbs-anim-wrapper"),
          e,
          a
        );
  });
...
function t_animationSBS__processTriggersElemList(t, e, n) {
  t &&
    ("once" === e.loop
      ? e.classList.contains("t-sbs-anim_started") ||
        t_animationSBS__initTriggersList(t, "triggerOnceList", n, e)
      : t_animationSBS__initTriggersList(t, "triggerList", n, e));
}
function t_animationSBS__initTriggersList(t, e, n, i) {
  t[e + "-on-" + n]
    ? -1 === t[e + "-on-" + n].indexOf(i) && t[e + "-on-" + n].push(i)
    : (t[e + "-on-" + n] = [i]),
    t[e + "-on-" + n].length &&
      !t.classList.contains("js-sbs-anim-trigger_" + n) &&
      t.classList.add("js-sbs-anim-trigger_" + n),
    i.addEventListener("updateAnimOnce", function () {
      (t[e + "-on-" + n] = t[e + "-on-" + n].filter(function (t) {
        return t !== i;
      })),
        (t["triggerList-on-" + n] && t["triggerList-on-" + n].length) ||
          t.classList.remove("js-sbs-anim-trigger_" + n);
    });
}
function t_animationSBS__actionOnStart(t) {
  t.forEach(t_animationSBS__setActionOnStart);
}
function t_animationSBS__setActionOnStart(t) {
  t.classList.contains("t-sbs-anim_playing")
    ? t.setAttribute("data-planned-dir", "play")
    : t_animationSBS__playAnimation(t, !1);
}
function t_animationSBS__actionOnEnd(t) {
  t.forEach(t_animationSBS__setActionOnEnd);
}
function t_animationSBS__setActionOnEnd(t) {
  var e = t.loop,
    n =
      "noreverse" === e && "hover" === t.getAttribute("data-animate-sbs-event");
  e && -1 !== e.indexOf("loop")
    ? t.addEventListener(
        "animationiteration",
        t_animationSBS__setIterationAnimation
      )
...
function t_animationSBS__setIterationAnimation(t) {
  ...
  if (e) {
    ...
    e.classList.remove("t-sbs-anim_started"),
      e.classList.remove("t-sbs-anim_reversed"),
      e.classList.remove("t-sbs-anim_playing"),
...
function t_animationSBS__animationEnd(t) {
  t.removeEventListener("animationend", t_animationSBS__animationEndingEvent),
    t.addEventListener("animationend", t_animationSBS__animationEndingEvent);
}
function t_animationSBS__animationEndingEvent() {
  ...
  "play" === t && this.classList.contains("t-sbs-anim_reversed")
    ? t_animationSBS__playAnimation(this, !1)
    : "reverse" !== t ||
      this.classList.contains("t-sbs-anim_reversed") ||
      t_animationSBS__playAnimation(this, !0),
...
function t_animationSBS__getAnimationFullTime(t, n) {
  return t.getAttribute("data-animate-sbs-opts")
    ? JSON.parse(
        t.getAttribute("data-animate-sbs-opts").split("'").join('"')
      ).reduce(function (t, e) {
        return (
          n && (t += parseInt(e.dt, 10) || 0), t + (parseInt(e.ti, 10) || 0)
        );
      }, 0)
    : 0;
}
function t_animationSBS__playAnimation(e, t) {
  e.classList.remove("t-sbs-anim_started"),
    t || e.classList.remove("t-sbs-anim_reversed"),
    t_animationSBS__forceRepaint(e);
...
function t_animationSBS__getZoom(t) {
  ...
  return t.classList.contains("t396__artboard_scale") ||
    (!window.animationSBS__isOldPage &&
      "undefined" != typeof t396_ab__getFieldValue &&
  ...
  Array.prototype.forEach.call(t, function (t) {
    ...
    n &&
      ...
      "shape" === n &&
        e &&
        parseInt(e) &&
        (n = t.querySelector(".tn-atom__sbs-anim-wrapper")) &&
        (n.style.borderRadius = e));
  });
}
function t_animateSbs__cashElsInfo(o) {
  var t = o.els;
  (o.triggerElemsAttrName =
    "edit" === o.mode
    ...
    Array.prototype.forEach.call(t, function (t) {
      if (
        ...
        (t.animType =
          "edit" === o.mode
            ? t.getAttribute("data-field-sbsevent-value")
            : t.getAttribute("data-animate-sbs-event")),
        (t.changeType = "scroll" === t.animType ? "scroll" : "time"),
        (t.trigger =
          "edit" === o.mode
            ? t.getAttribute("data-field-sbstrg-value")
            : t.getAttribute("data-animate-sbs-trg")),
        ...
        (e =
          "edit" === o.mode
            ? t.getAttribute("data-field-sbsopts-value")
            : t.getAttribute("data-animate-sbs-opts")))
      ) {
        -1 !== e.indexOf("fixed") &&
          (t.zIndex = window.getComputedStyle(t).getPropertyValue("z-index"));
        for (
          var e = e.replace(/'/g, '"'),
            n = JSON.parse(e),
            i =
              (t_animationSBS__addDelayToSteps(n),
              (t.loop =
                "edit" === o.mode
                  ? t.getAttribute("data-field-sbsloop-value")
                  : t.getAttribute("data-animate-sbs-loop")),
              t_animationSBS__setAndCacheElTopPos(t, o),
              0),
            a = 0;
          a < n.length;
          a++
          ...
          (r.styles = t_animationSBS__createStepStyles(n[a])),
            "scroll" === t.changeType
              ? ((r.prevUnfixedDist = i),
                (r.dist = n[a].di),
                !1 === r.styles.fix && (i += Number(r.dist)),
                (r.start = 0 === a ? t.topOffset : t.steps[a - 1].end),
                (r.end = r.start + +r.dist))
              : ((r.time = n[a].ti), (r.ease = n[a].ea)),
            t.steps.push(r);
        }
        t_animationSBS__updateInfoOnImgLoad(t, o),
          t_animationSBS__updateMoveAndRotateStepsStyles(t.steps);
      }
    });
}
function t_animateSbs__reset(t) {
  for (var e = t.els, n = 0; n < e.length; n++) {
    ...
    "intoview" === i || "blockintoview" === i || "click" === i || "hover" === i
      ? (e[n].classList.remove("t-sbs-anim_started"),
        (i = e[n].querySelector(".tn-atom__sbs-anim-wrapper")) &&
          (i.style.opacity = ""))
      : ((e[n].state = "reseted"),
        (i = e[n].wrapperEl) &&
          ((i.style.transform = ""),
...
(window.t_animationSBS__isFirefox =
  ...
  (window.t_animationSBS__isSafari = /^((?!chrome|android).)*safari/i.test(
    navigator.userAgent
  )),
  (window.animationSBS__isIOS =
    /iPhone|iPad|iPod/i.test(navigator.userAgent) ||
    ("ontouchend" in document && /Macintosh/.test(navigator.userAgent))),
  (window.animationSBS__isOldPage = Boolean(
